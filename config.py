...
class Config(BaseModel):
    ...
    # 模式开关
    onebot2tg_enable_bridge: bool = False
    """开启互通模式（双向转发，需配置互通群号）"""

    onebot2tg_enable_forward: bool = True
    """开启转发模式（QQ所有消息转发到TG私聊，默认开启）"""
    ...
    onebot2tg_forward_reply_chat_id: str | int = ""
    """转发模式下，TG私聊消息回复到QQ的目标群号"""
